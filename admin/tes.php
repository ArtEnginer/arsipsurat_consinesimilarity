...
// Set properties
$excelku->getProperties()->setCreator("amel")
                         ->setLastModifiedBy("amel");



// Mergecell, menyatukan beberapa kolom
$excelku->getActiveSheet()->mergeCells('A2:H2');
$excelku->getActiveSheet()->setCellValue('A2', "PEMERINTAH KOTA pekanbaru");
$excelku->getActiveSheet()->mergeCells('A3:H3');
$excelku->getActiveSheet()->setCellValue('A3', "KANTOR BALAI KOTA pekanbaru");
...
$excelku->getActiveSheet()->setCellValue('A5', "Jl.Sudirman 12, Telp. 482713 ");
